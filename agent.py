...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None):
        ...
        self.num_trial += 1
        print "Penalty Ratio: {:.3f}, Success Rate: {:.3f}, Cumulative Rewards: {}, Number of Moves: {}".format(self.penalty_ratio, self.success_rate, self.cumulative_rewards, self.timer)
    ...
    def update(self, t):
        ...
        # TODO: Update state
        alpha = 1.0 / (1.2 + float(self.timer) / 60.0)
        #alpha = 1.0
        gamma = 0.3
        ...
        epsilon = 1.0 / (1.0 + self.timer / 10.0)
        ...
        self.timer += 1
        self.penalty_ratio = float(self.num_penalty) / float(self.timer) * 100
